! function(t) {
    ...
    t.exports = function(t, n) {
        ...
        return function(n, s, p) {
            for (var v, g, y = o(n), w = i(y), m = r(s, p, 3), b = u(w.length), x = 0, S = e ? d(n, b) : c ? d(n, 0) : void 0; b > x; x++)
                if ((h || x in w) && (g = m(v = w[x], x, y), t))
                    if (e) S[x] = g;
                    else if (g) switch (t) {
                case 3:
                    return !0;
    ...
    (n = t.exports = function(t, n, e, l, h) {
        ...
        if (o(y)) {
            for (d = s(t.length); d > m; m++)
                if ((g = n ? w(u(p = t[m])[0], p[1]) : w(t[m])) === a || g === f) return g
        } else
            for (v = y.call(t); !(p = v.next()).done;)
                if ((g = i(v, w, p.value, n)) === a || g === f) return g
    }).BREAK = a, n.RETURN = f
}, function(t, n, e) {
    var r = e(1).navigator;
    ...
    t.exports = function(t, n, e, p, v, g, y) {
        ...
        if (F && (b = f(F.call(new t))) !== Object.prototype && b.next && (a(b, S, !0), r || "function" == typeof b[l] || u(b, l, d)), _ && M && "values" !== M.name && (E = !0, P = function() {
                return M.call(this)
            }), r && !y || !h && !E && O[l] || u(O, l, P), s[n] = P, s[S] = d, v)
            if (w = {
                    values: _ ? P : x("values"),
                    keys: g ? P : x("keys"),
                    entries: A
                }, y)
                for (m in w) m in O || o(O, m, w[m]);
    ...
    h && d || (h = function(t) {
        ...
        f.postMessage(t + "", "*")
    }, f.addEventListener("message", m, !1)) : r = "onreadystatechange" in a("script") ? function(t) {
    ...
    t.exports = !c || e(2)(function() {
        ...
        for (var e = u(t), c = arguments.length, a = 1, f = i.f, l = o.f; c > a;)
            for (var h, d = s(arguments[a++]), p = f ? r(d).concat(f(d)) : r(d), v = p.length, g = 0; v > g;) l.call(d, h = p[g++]) && (e[h] = d[h]);
        return e
    } : c
}, function(t, n) {
        ...
        var t, n = (t = regeneratorRuntime.mark(function t() {
            ...
            return regeneratorRuntime.wrap(function(t) {
                for (;;) switch (t.prev = t.next) {
                    ...
                    case 4:
                        e(313).default(), t.t0 = c, t.next = "index" === t.t0 ? 8 : 10;
                        break;
                    case 8:
                        return e(318).default(), t.abrupt("break", 10);
                    case 10:
                    case "end":
                        return t.stop()
                }
    ...
    i(i.S + i.F * !e(52)(function(t) {
        ...
        from: function(t) {
            var n, e, i, l, h = o(t),
                ...
                y = 0,
                w = f(h);
            if (g && (v = r(v, p > 2 ? arguments[2] : void 0, 2)), null == w || d == Array && s(w))
                for (e = new d(n = c(h.length)); n > y; y++) a(e, y, g ? v(h[y], y) : h[y]);
            else
                for (l = w.call(h), e = new d; !(i = l.next()).done; y++) a(e, y, g ? u(l, v, [i.value, y], !0) : i.value);
            return e.length = y, e
        }
    })
}, function(t, n, e) {
    ...
    "use strict";
    e(110), e(293), t.exports = e(7).Promise.finally
}, function(t, n, e) {
    "use strict";
    var r = e(0),
        i = e(7),
    ...
    for (var r = e(80), i = e(31), o = e(11), u = e(1), s = e(14), c = e(40), a = e(5), f = a("iterator"), l = a("toStringTag"), h = c.Array, d = {
        ...
        var g, y = p[v],
            ...
            m = u[y],
            b = m && m.prototype;
        if (b && (b[f] || s(b, f, h), b[l] || s(b, l, y), c[y] = h, w))
        ...
        function E(t, e) {
            ...
            if (r === n) {
                if (e.delegate = null, "throw" === e.method) {
                    if (t.iterator.return && (e.method = "return", e.arg = n, E(t, e), "throw" === e.method)) return p;
    ...
    var r = e(85),
        ...
        c = function(t, n, e) {
            ...
            for (a in d && (e = n), e)(f = !h && b && void 0 !== b[a]) && s(w, a) || (l = f ? b[a] : e[a], w[a] = d && "function" != typeof b[a] ? e[a] : g && f ? o(l, r) : y && b[a] == l ? function(t) {
    ...
    var u = "js-fullscreen-wrap",
        ...
        f = "js-fullscreen-bg",
        l = ["#5921e9", "#40d299", "#761df2", "#861034", "#3abdff", "#40c5ff", "#f06328", "#307bb6", "#5d0b8b"],
        h = function() {
            function t(n, e) {
                ! function(t, n) {
